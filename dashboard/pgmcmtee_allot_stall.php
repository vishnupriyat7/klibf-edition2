                    ...
                    <div class="card mt-xxl-n5">
                        ...
                        if (!$user_prof) {
                            ...
                            if (isset($_POST['submit-stall'])) {
                                ...
                                if ($term == "on") {
                                    if ($publisher_id && $user_stall) {
                                        $query = "UPDATE stall_booking SET stalls_3x3 = '$stall3x3', stalls_3x2 = '$stall3x2', status = 'S', updated_date = '$date' WHERE user_id = '$publisher_id'";
                                    } else {
                                        $query = "INSERT INTO stall_booking (stalls_3x3, stalls_3x2, status, updated_date, user_id) VALUES ('$stall3x3', '$stall3x2', 'S', '$date', '$publisher_id')";
                                    }
                                    $resultSub = mysqli_query($con, $query);
                                    $profile_sub = "UPDATE users_profile SET submitted = 1 WHERE user_id = '$publisher_id'";
                          ...
                          <div class='alert alert-success alert-dismissible alert-outline fade show'>
                            ...
                            if (isset($_POST['save_stall'])) {
                                ...
                                if ($term == "on") {
                                    ...
                                    $errormsg = "";
                                    if ($publisher_id && $user_stall) {
                                        $query = "UPDATE stall_booking SET stalls_3x3 = '$stall3x3', stalls_3x2 = '$stall3x2', status = 'E', updated_date = '$date' WHERE user_id = '$publisher_id'";
                                    } else {
                                        $query = "INSERT INTO stall_booking (stalls_3x3, stalls_3x2, status, updated_date, user_id) VALUES ('$stall3x3', '$stall3x2', 'E', '$date', '$publisher_id')";
                                    }
